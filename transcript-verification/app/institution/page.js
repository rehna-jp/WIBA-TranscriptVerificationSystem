          ...
          {activeTab === 'issue' && (
            <form onSubmit={handleSubmit} className="max-w-2xl">
              <div className="space-y-6">
                ...
                >
                  {submitting ? 'Issuing Credential...' : 'Issue Credential'}
                </button>
              </div>
            </form>
          )}
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-gray-200">
                        <th className="text-left py-4 px-4 font-semibold text-gray-700">Credential ID</th>
                        <th className="text-left py-4 px-4 font-semibold text-gray-700">Student Address</th>
                        ...
                        <th className="text-left py-4 px-4 font-semibold text-gray-700">Issued</th>
                    ...
                    <tbody>
                      {filteredCredentials.map((cred) => (
                        <tr key={cred.id} className="border-b border-gray-100 hover:bg-gray-50">
                          <td className="py-4 px-4 font-mono text-sm text-gray-900">{cred.id}</td>
                          <td className="py-4 px-4 font-mono text-sm text-gray-600">
                            {cred.studentAddress.slice(0, 6)}...{cred.studentAddress.slice(-4)}
                          </td>
                          <td className="py-4 px-4 text-gray-600">{credentialTypes[cred.credentialType]}</td>
                          <td className="py-4 px-4 text-gray-600">{cred.graduationYear}</td>
