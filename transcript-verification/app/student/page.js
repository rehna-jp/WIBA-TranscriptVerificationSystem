                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mb-6">
                    <div>
                      ...
                      <p className="font-mono text-gray-900">{cred.id}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="font-mono text-sm text-gray-900">{cred.ipfsCid}</p>
                    </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-gray-700 space-y-1">
                    <li>• Use the "Copy CID" button to share your IPFS content identifier</li>
                    <li>• Use the "Copy Hash" button for document hash verification</li>
                    <li>• Share the "View on IPFS" link to allow direct document access</li>
                    <li>• Employers can verify your credentials using the Verifier Portal</li>
                  </ul>
                </div>
              </div>
            </div>
