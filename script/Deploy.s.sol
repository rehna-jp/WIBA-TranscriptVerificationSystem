...
contract DeployScript is Script {
    function run() external {
        ...
        string memory deploymentInfo = string.concat(
            "INSTITUTION_REGISTRY_ADDRESS=", vm.toString(address(registry)), "\n",
            "TRANSCRIPT_MANAGER_ADDRESS=", vm.toString(address(transcriptManager)), "\n",
            "ADMIN_ADDRESS=", vm.toString(deployer), "\n"
        );
